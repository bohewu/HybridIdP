    ...
    <div class="border-t border-gray-200 px-4 py-5 sm:p-0">
      <dl class="sm:divide-y sm:divide-gray-200">
        <div class="py-3 sm:py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
          <dt class="text-sm font-medium text-gray-500">{{ t('profile.displayName') }}</dt>
      ...
      <div class="border-t border-gray-200 px-4 py-5 sm:px-6 bg-gradient-to-r from-blue-50/50 to-transparent">
        ...
        <div class="space-y-2">
          ...
          <div class="flex items-center gap-3 text-sm">
            <span v-if="profile.twoFactorEnabled || profile.emailMfaEnabled || profile.passkeyEnabled" class="inline-flex items-center gap-1.5 text-green-700">
      ...
      <ul class="divide-y divide-gray-200">
        <li v-for="login in profile.externalLogins" :key="login.providerKey" class="px-4 py-4 sm:px-6 flex items-center justify-between">
          <div class="flex items-center">
            <!-- Google Logo -->
            <img v-if="login.loginProvider === 'Google'" 
                 src="https://www.gstatic.com/images/branding/product/1x/googleg_48dp.png" 
                 class="h-5 w-5 mr-3" 
                 alt="Google" />
            <!-- Microsoft Logo -->
            <img v-else-if="login.loginProvider === 'Microsoft'" 
        ...
        <div v-if="canRemove">
          ...
          >
            ...
            <span>{{ t('profile.common.remove') }}</span>
          </button>
    ...
    <div class="border-t border-gray-200">
      <ul class="divide-y divide-gray-200">
        <li v-for="provider in profile.availableProviders" :key="provider.scheme" class="px-4 py-4 sm:px-6 flex items-center justify-between">
          <div class="flex items-center">
            <!-- Google Logo -->
            <img v-if="provider.scheme === 'Google'" 
                 src="https://www.gstatic.com/images/branding/product/1x/googleg_48dp.png" 
                 class="h-5 w-5 mr-3" 
                 alt="Google" />
            <!-- Microsoft Logo -->
            <img v-else-if="provider.scheme === 'Microsoft'" 
                 src="https://www.microsoft.com/favicon.ico" 
                 class="h-5 w-5 mr-3" 
                 alt="Microsoft" />
