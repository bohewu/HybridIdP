  ...
  <div class="audit-log-viewer">
    ...
    <div class="bg-white shadow-sm rounded-lg border border-gray-200">
      ...
      <div v-if="!loading && auditEvents.length > 0" class="px-4 py-3 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
        ...
        <button
          @click="emit('refresh')"
          class="inline-flex items-center px-3 py-1.5 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-google-500"
        >
