...
<style>
/* Using Tailwind utilities, so custom styles are minimal */
.form-input-sm {
  @apply block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm h-10 px-3;
}
</style>