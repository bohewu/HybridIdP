...
namespace Core.Application
{
    public interface IAuditService
    {
        ...
        Task<(IEnumerable<AuditEventDto> items, int totalCount)> GetEventsAsync(AuditEventFilterDto filter, CancellationToken cancellationToken = default);
        ...
        Task<AuditEventExportDto?> ExportEventAsync(int eventId, CancellationToken cancellationToken = default);
        ...
        /// <param name="userAgent">Client user agent</param>
        /// <returns>Task</returns>
        Task LogRoleSwitchAsync(Guid userId, Guid oldRoleId, Guid newRoleId, string sessionAuthorizationId, string ipAddress, string userAgent, CancellationToken cancellationToken = default);
        ...
        /// <param name="userAgent">Client user agent</param>
        /// <returns>Task</returns>
        Task LogAccountSwitchAsync(Guid currentUserId, Guid targetAccountId, string reason, string ipAddress, string userAgent, CancellationToken cancellationToken = default);
    }
}
